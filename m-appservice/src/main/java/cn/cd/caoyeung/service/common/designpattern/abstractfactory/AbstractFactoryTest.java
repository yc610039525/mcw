...
/**
 * 抽象工厂模式保证 每个类型的工厂只生产 对应类型的实例 
 * 保证一个系列一个系列的产品消费 产品之间可以自由组合 但是扩展组件困难
		主要解决：主要解决接口选择的问题。
...
public class AbstractFactoryTest {
	public static void main(String[] args) {
		IFormFactory wfFactory = new WindowsFormFactory();
		System.out.println(wfFactory.createButton().getButton());
		System.out.println(wfFactory.createText().getText());
	}
}
